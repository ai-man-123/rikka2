...
async function canvas(code, type = 'png', quality = 0.92) {
  let res = await fetch('https://a59f-157-230-241-66.ngrok.io/api/canvas?' + queryURL({
    type,
    quality
  }), {
    method: 'POST',
...
async function addExif(webpSticker, packname, author, categories = [''], extra = {}) {
  ...
  const json = { 'sticker-pack-id': `RIKKA-BOT-`+stickerPackId, 'sticker-pack-name': packname, 'sticker-pack-publisher': author, 'emojis': categories, ...extra };
